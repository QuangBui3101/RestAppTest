...
let AppComponent = class AppComponent {
    constructor(httpClient) {
        ...
        this.header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ ContentType: 'application/xml' }).set('Accept', 'application/xml');
        this.title = 'angularClient';
    }
    OnClick() {
        this.httpClient
            .get('http://localhost:5000/HelloWorld/', { headers: this.header, responseType: 'text' })
            .subscribe(r => {
            console.log(r);
